<template>
    <div class="index-w">
        ...
        <div class="index-content-w menu-content-w">
            ...
            <el-table :data="examList" :stripe="true">
                ...
                <el-table-column label="操作" width="220">
                    <template slot-scope="scope">
                        ...
                        <el-button @click.native.prevent="removeEvent(scope.row)"
                                   type="primary"
                                   size="small">删除
                        </el-button>
                    </template>
            ...
            <el-dialog title="考试详细信息" :visible.sync="detailExamDialog" width="600px">
            ...
            <el-dialog title="编辑考试信息" :visible.sync="examEditDialog">
                <el-form :model="editForm" :rules="editFormRules" ref="editForm" label-width="100px"
                    ...
                    <el-form-item label="考试费用" prop="payMoney">
                        <el-input v-model="editForm.payMoney"></el-input>
                    </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            searchEvent() {
                functions.getAjax('/exam/findAll' + '?pageNum=0&examName=' + this.searchForm.name, (res) => {
                    console.log(res);
                    this.examList = res.data.content;
                });
            },
            ...
            //动态转换时间组件数据
            updateExamTime(time) {
                this.editForm.examStart = time[0];
                this.editForm.examEnd = time[1];
            },
            updateApplyTime(time) {
                this.editForm.applyStart = time[0];
                this.editForm.applyEnd = time[1];
            },
